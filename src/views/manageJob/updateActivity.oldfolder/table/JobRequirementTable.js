...
const JobRequirementTable = ({isOpen, setIsOpen,inputFile,handleSubmit,activityRequirement, submitBtn,requriementName }) => {
...
>
<ListingTypeForm setIsOpen={setIsOpen} inputFile={inputFile} requriementName={requriementName.requirementName} submitBtn={submitBtn} handleSubmit={handleSubmit} metata ={metata} />
